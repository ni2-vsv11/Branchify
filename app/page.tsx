    ...
    <main>
      <section className="bg-[#254F1A] min-h-[100vh] grid grid-cols-2 ">
        <div className=" flex item-center justify-center flex-col ml-[10vw] gap-3 pt-30">
         <span className="text-yellow-300 font-black text-7xl">Everything you </span>
          <span className="text-yellow-300 font-black text-7xl">are. In one,</span> 
          <span className="text-yellow-300 font-black text-7xl">simple link in bio.</span>
